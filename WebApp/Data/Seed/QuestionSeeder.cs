        ...
        if (tasks.TryGetValue(4, out var task4))
        {
            db.TaskQuestions.Add(
                new MatchingQuestion
                {
                    ...
                    Order = 1,
                    Points = 8,
                    TextRu = "Перетащите термины в правой колонке так, чтобы каждый из них оказался напротив своего определения слева.",
                    TextKk = "Оң жақ бағандағы терминдерді әрқайсысы сол жақтағы анықтамасына қарама-қарсы болатындай етіп сүйреңіз.",
